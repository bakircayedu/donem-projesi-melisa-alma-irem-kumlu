    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav" style="b">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          ...
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="Dosyalar/img/profil.jpg" alt="">
      ...
      <div class="collapse navbar-collapse" style="background-color:darkred" id="navbarSupportedContent">
        <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#skills">Profesyonel Yeteneklerim</a>
          </li>
          <li class="nav-item">
